...
.. admonition:: 语法要点
  ...
  | *相关参考链接*
  | `<https://sphinx-doc.readthedocs.io/zh-cn/master/usage/restructuredtext/directives.html>`_ 
  | `<http://www.pythondoc.com/sphinx/markup/toctree.html>`_ 
...
.. admonition:: 语法要点
    ...
    - 外部引用代码指令为 ``literalinclude``.可选参数有包含bacode-block外的： ``encoding编码`` | ``lines引用指定行`` .
